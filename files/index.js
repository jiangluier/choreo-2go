...
const UUID = process.env.UUID || '7d1ea4e7-5665-465f-9282-8a7e6f72ddf3'; //若需要改UUID，需要在config.json里改为一致
const NEZHA_SERVER = process.env.NEZHA_SERVER || 'nezha.vexio.ggff.net';     
const NEZHA_PORT = process.env.NEZHA_PORT || '443';                     // 哪吒端口为{443,8443,2096,2087,2083,2053}其中之一开启tls
const NEZHA_KEY = process.env.NEZHA_KEY || '1OnWuGDXRRHwIWnVX9';   // 没用哪吒，把这个参数空着
const ARGO_DOMAIN = process.env.ARGO_DOMAIN || 'choreo.luijianger.dpdns.org';     // 建议使用token，argo端口8080，cf后台设置需对应,使用json需上传json和yml文件至files目录
const ARGO_AUTH = process.env.ARGO_AUTH || 'eyJhIjoiYjAzZTBhYWJkNmQxNWFlOGIzNzFlNjA3NTcyZWM4OTQiLCJ0IjoiZjYwNzQ0ZDMtMzk3My00NDg3LTg5MWEtMDlkMzRmYThlMzUwIiwicyI6IlkySXlOekE1TnprdFlXUXdOaTAwWm1RNUxUazFOakV0TVRnNFptTXlOV0pqWVdFeiJ9';
